...
func run() error {
	...
	concurrency := flag.Int("concurrency", xlsxfill.DefaultConcurrency, "concurrent date/store query jobs (1-160)")
	pageConcurrency := flag.Int("page-concurrency", 16, "maximum concurrent RTA page requests after page one")
